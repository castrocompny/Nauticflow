-- O cadastro agora pede a cidade da empresa; o gatilho passa a salvar isso direto
-- em companies.city (antes só dava pra preencher depois, em Configurações).
...
begin
  ...
  insert into public.companies (name, city) values (v_company_name, v_city) returning id into v_company_id;
